public class EnergyAttackMove : AttackMove
{
    ...
    public static EnergyAttackMove Ember = new EnergyAttackMove(0, "Ember", "Burn the target with 50% of attack as the damage. Cost 10.", 1, TypeAttribute.Fire, TypeTargetSelection.SingleTarget, .5f, 1f, 10, false, has_secondary_effect: true, lasting_status_effect_type: TypeLastingStatusEffect.Burn, secondary_effect_chance: .1f, next_level_move: EnergyAttackMove.FlameThrower, upgrade_cost: 10);
    public static EnergyAttackMove FireBlast = new EnergyAttackMove(1, "Fire Blast", "Burn all targets with 10% of attack as the damage. Cost 15.", 1, TypeAttribute.Fire, TypeTargetSelection.MultipleTarget, .1f, 1f, 15, false);
