public class EnergyAttackMove : AttackMove
{
    ...
    public static EnergyAttackMove Void = new EnergyAttackMove(1, "Void", "Do nothing. Cost 10000000.", 1, TypeAttribute.Fire, TypeTargetSelection.SingleTarget, 0f, 1, 10000000);
