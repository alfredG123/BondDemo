...
{
    public static StatusMove DamageUpSmall = new StatusMove(0, nameof(DamageUpSmall), "Gain a damage boost buff for the user. Cost 10.", 1, TypeTargetSelection.MultipleAlliesIncludeSelf, 1f, 10, true, temporary_status_effect_type: TypeTemporaryStatusEffect.DamageUpSmall);
    public static StatusMove Posion = new StatusMove(1, nameof(Posion), "Posion the target. Cost 10.", 1, TypeTargetSelection.SingleTarget, 1f, 10, true, lasting_status_effect_type: TypeLastingStatusEffect.Posioned);
    public static StatusMove Burn = new StatusMove(2, nameof(Burn), "Burn the target. Cost 10.", 1, TypeTargetSelection.SingleTarget, 1f, 10, true, lasting_status_effect_type: TypeLastingStatusEffect.Burn);
