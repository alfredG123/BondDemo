...
{
    public static StatusMove Howl = new StatusMove(0, "Howl", "Gain a damage boost buff for the user.", 1, TypeTargetSelection.SelfTarget, 100, 10, temporary_status_effect_type: TypeTemporaryStatusEffect.DamageUpSmall);
    ...
    public StatusMove(int value, string name, string description, int priority, TypeTargetSelection target_selection_type, int accuracy, int energy_cost, TypeFieldEffect field_effect_type = TypeFieldEffect.None, TypeLastingStatusEffect lasting_status_effect_type = TypeLastingStatusEffect.None, TypeTemporaryStatusEffect temporary_status_effect_type = TypeTemporaryStatusEffect.None)
        : base(value, name, description, TypeMove.StatusMove, priority)
    {
